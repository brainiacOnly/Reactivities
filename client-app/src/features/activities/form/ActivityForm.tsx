...
const validate = combineValidators({
    ...
    description: composeValidators(isRequired('Desctiption'), hasLengthGreaterThan(4)({message: 'Description needs to be at least 5 characters'}))(),
                    ...
                    <FinalForm onSubmit={handleFinalFormSubmit}
                                ...
                                render={({handleSubmit, invalid, pristine}) => (
                                    <Form onSubmit={handleSubmit} loading={loading}>
                                        ...
                                        <Button floated='right' positive type='submit' content='Submit' loading={submitting}  disabled={loading || invalid || pristine} />
